...
trap "echo ''; info 'Shutting down...'; kill $INGEST_PID $AI_PID $GRPC_PID $BRIDGE_PID 2>/dev/null; docker compose -f docker-compose.yml stop; success 'Stopped.'" SIGINT SIGTERM
